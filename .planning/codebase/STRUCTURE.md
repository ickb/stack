...
│   ├── pins/                       # Committed: single SHA-named file (base, refs, resolutions)
│   │   └── <HEAD_SHA>              # Expected HEAD after replay
...
- `pins/`: Committed directory with single SHA-named file (base SHA, merge refs, conflict resolutions)
...
- `pins/`: Committed directory containing a single SHA-named file (base SHA, merge refs, base64-encoded conflict resolutions)
