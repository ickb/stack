...
import { readLinuxProcessIdentity } from "../../../packages/node-utils/src/process.ts";
...
const launcherRootDir = path.resolve(fileURLToPath(new URL("../../..", import.meta.url)));
