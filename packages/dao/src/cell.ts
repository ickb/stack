...
export class I8Script implements Script {
  ...
  static from(i: I8Scriptable) {
    return Object.freeze(i instanceof I8Script ? i : new I8Script(i));
  }
}
...
export class I8OutPoint implements OutPoint {
  ...
  static from(i: OutPoint) {
    return Object.freeze(i instanceof I8OutPoint ? i : new I8OutPoint(i));
  }
}
...
export class I8CellOutput implements I8CellOutputable {
  ...
  static from(i: I8CellOutputable) {
    return Object.freeze(i instanceof I8CellOutput ? i : new I8CellOutput(i));
  }
}
...
export class I8Cell implements I8Cellable {
  ...
  private constructor(i: Partial<I8Cellable> & Partial<I8CellOutputable>) {
    ...
    if (BigInt(capacity) <= 0n) {
      this.cellOutput = I8CellOutput.from({
        capacity: minimalCellCapacityCompatible(this, {
          validate: false,
        }).toHexString(),
        lock,
        type,
...
export class I8CellDep implements CellDep {
  ...
  static from(i: CellDep) {
    return Object.freeze(i instanceof I8CellDep ? i : new I8CellDep(i));
  }
}
...
export class I8Header implements Header {
  ...
  static from(i: Header) {
    return Object.freeze(i instanceof I8Header ? i : new I8Header(i));
  }
}
