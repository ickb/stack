...
export const Uint8: FixedBytesCodec<number, number | string | bigint> = Object.freeze(U8);
export const Uint16: FixedBytesCodec<number, number | string | bigint> = Object.freeze(U16);
export const Uint32: FixedBytesCodec<number, number | string | bigint> = Object.freeze(U32);

export const Uint64: FixedBytesCodec<bigint, number | string | bigint> = Object.freeze({
    ...U64,
    unpack: (unpackable: BytesLike) => U64.unpack(unpackable).toBigInt(),
});


export const Uint128: FixedBytesCodec<bigint, number | string | bigint> = Object.freeze({
    ...U128,
    unpack: (unpackable: BytesLike) => U128.unpack(unpackable).toBigInt(),
});

export const Int32 = Object.freeze(createFixedBytesCodec<number>(
    {
        byteLength: 4,
        pack: (packable) => {
