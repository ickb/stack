...
graph TD;
    ...
    click C "https://github.com/ickb/stack/tree/master/packages/faucet" "Go to @ickb/faucet"
```
...
```bash
git clone https://github.com/ickb/stack/tree/master/packages/faucet.git
```
...
This source code, crafted with care by [Phroi](https://phroi.com/), is freely available on [GitHub](https://github.com/ickb/stack/tree/master/packages/faucet) and it is released under the [MIT License](https://github.com/ickb/stack/LICENSE).
