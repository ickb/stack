...
export const activeChain = walletGateStateModule.activeChain;
export const activeConnectedChain = walletGateStateModule.activeConnectedChain;
export const selectedClient = walletGateStateModule.selectedClient;
