...
jq -r 'select(.decision.match.reason == "search_incomplete") | .decision.match.diagnostics | "\(.workCount) \(.gainUpperBound)"' "$BOT" | sort | uniq -c
